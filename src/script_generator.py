...
✅ **4. 専門用語は"短く言い換え"→詳細は後で**
- 冒頭では専門用語を避ける
- 例：「リポ率が上がった」→「インドの政策金利が引き上げられました（これがリポ率です）」
- 難しい用語は後半で補足説明
...
【まとめ（20秒）】
[3つのポイント再確認 + 視聴者へのメッセージ]

【CTA：チャンネル登録のお願い（60秒）】
このセクションは必須です。以下の要素を自然に組み込んでください：

✅ **1. いいねボタンのお願い（15秒）**
- 「この動画が役に立ったと思ったら、ぜひいいねボタンをお願いします」
- 「いいねをいただけると、より多くの投資家の方に情報をお届けできます」

✅ **2. チャンネル登録の訴求（20秒）**
- 「チャンネル登録がまだの方は、ぜひ登録をお願いします」
- 「毎日、最新の金融・市場ニュースを分かりやすく解説しています」
- 「通知ボタンもオンにしていただくと、重要なニュースを見逃しません」

✅ **3. 価値の再確認（15秒）**
- 「このチャンネルでは、複数のメディアの情報を総合的に分析」
- 「投資判断に役立つ情報を、忙しいあなたに代わって整理してお届けしています」
