...
【評価の視点】
国際分散投資に興味のある日本の個人投資家にとって、この記事はどれくらい重要か？

【評価基準】
- 日本の個人投資家にとっての価値（実際に投資判断に役立つか）
- 国際分散投資の視点からの重要性（米国株、新興国株、債券、為替など）
- 市場への影響度（株価、為替、金利への影響）
- 注目度（個人投資家が注目しているトピックか）
- 緊急性・速報性
- グローバルな影響
...
【重要】
- 国際分散投資をしている日本の個人投資家にとって、本当に価値がある情報かを重視してください
...
"""
            ...
            response = self.openai_client.chat.completions.create(
                model="gpt-4o-mini",
                messages=[
                    {"role": "system", "content": "あなたは国際分散投資に興味のある日本の個人投資家の視点で、記事の話題性を評価する専門家です。記事の内容から実際の新しさも判断してください。"},
                    {"role": "user", "content": prompt}
                ],
                max_tokens=10,
                temperature=0.3,
