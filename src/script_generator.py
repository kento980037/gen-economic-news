...
2. ポイント1（約240-300秒分 = 1200-1500文字）
   ⚠️ 必ず1200文字以上書く
   - 1つ目の重要ポイントを深掘り
...
3. ポイント2（約240-300秒分 = 1200-1500文字）
   ⚠️ 必ず1200文字以上書く
   - 2つ目の重要ポイントを深掘り
...
4. ポイント3（約240-300秒分 = 1200-1500文字）
   ⚠️ 必ず1200文字以上書く
   - 3つ目の重要ポイントを深掘り
   - 追加の背景や関連情報を深掘り
   - 他国・他市場との比較（具体的なデータで）
...
出力前に必ず以下を確認してください：
1. ポイント1の文字数は1200文字以上ありますか？
2. ポイント2の文字数は1200文字以上ありますか？
3. ポイント3の文字数は1200文字以上ありますか？
4. 台本全体で5400文字前後ありますか？
...
⚠️ 上記の例文は短縮版です。実際の台本では各ポイントを4-6倍に拡張してください。
"""
